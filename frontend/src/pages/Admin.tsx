...
export default function Admin() {
  ...
  const load = async () => {
    ...
    api.get("/admin/thresholds").then((r) => setThresholds(r.data)).catch(() => {});
  ...
  const updateThreshold = async () => {
    try {
      await api.post("/admin/thresholds", thresholds);
      setMessage("Thresholds accepted (apply on restart in this build)");
    } catch (e) {
      setMessage(getErrorMessage(e));
    }
  };
